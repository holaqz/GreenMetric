...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'Двухфакторная аутентификация теперь включена. Отсканируйте QR-код или введите ключ настройки в ваше приложение-аутентификатор',
            buttonText: 'Закрыть',
        };
    }
    ...
    return {
        ...
        description:
            'Чтобы завершить включение двухфакторной аутентификации, отсканируйте QR-код или введите ключ настройки в ваше приложение-аутентификатор',
        buttonText: 'Продолжить',
    };
});
