...
// Если пользователь авторизован, перенаправляем на /cycles
const page = usePage();
onMounted(() => {
    if ((page.props.auth as any)?.user) {
        router.visit('/cycles', { preserveState: false });
    }
});
</script>
            ...
            >
                ...
                >
                    ...
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Elios предоставляет мощные возможности для управления данными. <br />Рекомендуем начать со следующего.
                    </p>
